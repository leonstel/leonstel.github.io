...
### Google Map Instance Methods
 ...
 I will show two of the methods from the `GoogleMapsInstance`, but I can't cover them all indepth in this articles.
 You can find all of them in `src/app/map/GoogleMapInstance.ts`.
