...
case of the recursion will be triggered when the leaf does not have any children. No children means that it outputs no &lt;custom-leaf&gt; any more and the feedback loop stops.
